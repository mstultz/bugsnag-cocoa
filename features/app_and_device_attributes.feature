Feature: App and Device attributes present
  ...
  Scenario: App and Device info is as expected
    ...
    And the payload field "events.0.device.osName" equals "Mac OS"
    ...
    And the payload field "events.0.app.id" equals "com.bugsnag.macOSTestApp"
    And the payload field "events.0.app.releaseStage" equals "development"
    And the payload field "events.0.app.type" equals "macOS"
